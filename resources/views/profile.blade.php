        ...
        <div class="row">
            <div class="column">
                <div class="ui cards">
                    <div class="card">
                        <div class="image">
                            <img src="//eu.ui-avatars.com/api/?size=290&&color=ffffff&background=555b6e&name={{$user->surname}}&format=svg">
                        </div>
                        <div class="content">
                        ...
                        @if (Auth::check())
                            ...
                            @else
                                    <div class="ui {{ $is_follow ? '' : 'primary' }} follow button" data-following="{{ $is_follow ? 'false' : 'true' }}" data-id="{{ $user->id }}">
